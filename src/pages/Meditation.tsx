        ...
        <div className="meditation">
            ...
            <div className="meditation-info">
                <div className="each-meditation-info">
                    ...
                    <div data-aos="fade-down" className="each-meditation-inf-section">
                        <h1>Meditation</h1>
                ...
                <div className="each-meditation-info-1">
                    <div data-aos="fade-right" className="each-meditation-inf-section-1">
                    ...
                    <img data-aos="fade-left" src="https://static.mindvalley.com/public/assets/2019/07/8MOR_omvana-lp-img-meditationforeveryone_s508.png" alt="" />
                </div>
                <div className="each-meditation-info-2">
                    ...
                    <div className="each-meditation-inf-section-2">
                        ...
                        <h1 data-aos="fade-left">Release Body and Mind</h1>
                        <p data-aos="fade-left">Let's move together and energize body and mind. For half an hour we release stress from the body with light exercises to be prepared for the day.</p>
                    </div>
                </div>
